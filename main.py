...
'''
This script creates a CSV file that includes the total number of messages you have with every Facebook conversation,
over time. From here, a bar chart race can be created to visualize your conversations. For more information, see the guide
at https://towardsdatascience.com/step-by-step-tutorial-create-a-bar-chart-race-animation-da7d5fcd7079.
Flourish is a program which can create Bar Chart races, given a CSV file, and that's exactly what happens here.
'''
